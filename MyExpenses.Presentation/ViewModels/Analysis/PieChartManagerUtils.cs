...
{
    public static IEnumerable<CategoryTotalDataViewModel> AggregateCategoryTotalsBySign(this IEnumerable<DetailTotalCategoryViewModel> data,
        ...
        bool positive = true, bool negative = true)
    {
        ...
        var categoriesTotals = data
            ...
            {
                Category = g.Key,
                Total = Math.Round(g.Sum(s => s.Value), 2),
    ...
    public static void UpdateChartUi(this ObservableCollection<ISeries> series,
        ObservableCollection<CategoryTotalViewModel> categoryTotals,
        IEnumerable<CategoryTotalDataViewModel> categoriesTotals, double grandTotal)
    {
        ...
        var categoryTotalDatas = categoriesTotals as CategoryTotalDataViewModel[] ?? categoriesTotals.ToArray();
    ...
    private static void UpdateOrCreatePieSeries(this ObservableCollection<ISeries> series, Dictionary<string, PieSeries<double>> existingSeries,
        CategoryTotalDataViewModel categoryTotal, double absTotal, double percentage)
    {
    ...
    private static void UpdateOrCreateCategoryTotal(this ObservableCollection<CategoryTotalViewModel> categoryTotals, Dictionary<string, CategoryTotalViewModel> categoryTotalsDict,
        CategoryTotalDataViewModel categoryTotal, double percentage)
    {
    ...
    private static void RemoveObsoleteElements(this ObservableCollection<ISeries> series,
        ...
        ObservableCollection<CategoryTotalViewModel> categoryTotals,
        Dictionary<string, CategoryTotalViewModel> categoryTotalsDict,
        CategoryTotalDataViewModel[] categoryTotalDatas)
    {
