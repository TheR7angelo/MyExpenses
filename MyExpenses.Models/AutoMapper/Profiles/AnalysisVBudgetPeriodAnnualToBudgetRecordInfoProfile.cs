...
public class AnalysisVBudgetPeriodAnnualToBudgetRecordInfoProfile : Profile
{
    public AnalysisVBudgetPeriodAnnualToBudgetRecordInfoProfile()
    {
        CreateMap<AnalysisVBudgetPeriodAnnual, BudgetRecordInfo>()
