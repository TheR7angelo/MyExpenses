...
public class AnalysisVBudgetMonthlyGlobalToBudgetRecordInfoProfile : Profile
{
    public AnalysisVBudgetMonthlyGlobalToBudgetRecordInfoProfile()
    {
        CreateMap<AnalysisVBudgetMonthlyGlobal, BudgetRecordInfo>()
