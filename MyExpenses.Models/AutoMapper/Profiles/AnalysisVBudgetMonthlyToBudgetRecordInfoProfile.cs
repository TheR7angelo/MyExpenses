...
public class AnalysisVBudgetMonthlyToBudgetRecordInfoProfile : Profile
{
    public AnalysisVBudgetMonthlyToBudgetRecordInfoProfile()
    {
        CreateMap<AnalysisVBudgetMonthly, BudgetRecordInfo>()
