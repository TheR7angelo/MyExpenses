...
public class AnalysisVBudgetPeriodAnnualGlobalToBudgetRecordInfoProfile : Profile
{
    public AnalysisVBudgetPeriodAnnualGlobalToBudgetRecordInfoProfile()
    {
        CreateMap<AnalysisVBudgetPeriodAnnualGlobal, BudgetRecordInfo>()
