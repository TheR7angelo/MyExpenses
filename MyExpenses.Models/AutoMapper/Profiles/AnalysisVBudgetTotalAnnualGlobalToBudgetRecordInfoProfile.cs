...
public class AnalysisVBudgetTotalAnnualGlobalToBudgetRecordInfoProfile : Profile
{
    public AnalysisVBudgetTotalAnnualGlobalToBudgetRecordInfoProfile()
    {
        CreateMap<AnalysisVBudgetTotalAnnualGlobal, BudgetRecordInfo>()
