...
public class Migration_1_1_0_To_1_2_0 : IDatabaseMigration
{
    public Version From => new(1, 1, 0);
    public Version To => new(1, 2, 0);
    ...
    public string Command => @"
                            ...
                            UPDATE t_account
                            SET account_type_fk = 1
                            WHERE account_type_fk IS NULL;
                            
                            UPDATE t_account
                            SET currency_fk = 1
                            WHERE currency_fk IS NULL;
                            ...
                            SELECT id, name, account_type_fk, currency_fk, active, date_added
                            FROM t_account;
                            ...
                            UPDATE t_history
                            SET category_type_fk = 0
                            WHERE category_type_fk IS NULL;
                            
                            UPDATE t_history
                            SET mode_payment_fk = 1
                            WHERE mode_payment_fk IS NULL;
